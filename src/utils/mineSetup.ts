...
/**
 * deppping to other shuffle version.
 ...
 * do this by selecting a random node from a list of candidates.
...
const swapHasMineRand = (
  ...
  console.info(notHasMineIndexList, '---------nothasminelist---------');
 ...
 * [1, 2, 3, 4] -> [[1, 2,], [3, 4]] with 2 cols per row
 * @param bigArray
 * @param numCols
 * @returns
 */
